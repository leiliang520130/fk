...
<div class="main-container" id="main-container">
    ...
    <div class="page-header"><h1><i class="fa fa-home"></i>房卡卖给玩家</h1></div>
    <div class="col-xs-12">
        <section class="container">
            <div class="row">
                <div class="col-sm-9">
                    <div class="panel panel-default">
                        <p class="panel-heading">玩家充值</p>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="inputId" class="col-sm-3 control-label">玩家游戏ID：</label>
                                <div class="col-sm-4">
                                    <input type="text" name="pid" class="form-control" id="inputId" placeholder="请输入玩家游戏ID">
                                </div>
                            </div>
    ...
    <script>
        $(function () {
            $("#sub").on('click',function () {
                ...
                if(pid == '') {
                    layer.msg('请输入玩家ID',{icon:2,time:1000});
                    return false;
                }
                if(num == '') {
                ...
                layer.confirm("请确认信息是否正确,错误交易房卡不可退回!", {
                    ...
                    $.post("<?php echo U('Card/play_buy');?>",{pid:pid,num:num,remark:remark},function(r){
                        if(r.code == 0) {
