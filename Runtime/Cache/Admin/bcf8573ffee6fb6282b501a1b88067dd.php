...
<div class="navbar navbar-default" id="navbar">
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left"><a href="#" class="navbar-brand">
            <small><i class="icon-leaf"></i> fk管理后台</small>
        </a></div>
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"><img
                        class="nav-user-photo" src="/Public/statics/aceadmin/avatars/user.jpg" alt="Jason's Photo"/> <span
...
<div class="main-container" id="main-container">
    ...
    <div class="page-header"><h1><i class="fa fa-home"></i> 文章列表</h1></div>
    <div class="col-xs-12">
        <div class="tabbable"> 文章列表</div>
    </div>
